  ...
  <div class="admin-shell">
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <!-- Admin: full band management -->
        <template v-if="isAdmin">
          <div class="nav-group-label">Your Band</div>
        ...
        <!-- Admin + Publisher: posts -->
        <template v-if="isAdmin || isPublisher">
          <div class="nav-group-label">Promotion</div>
        ...
        <template v-if="isAdmin">
          ...
          <div class="nav-group-label">Shows</div>
